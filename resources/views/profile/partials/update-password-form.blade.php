<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label  class="text-xl" for="update_password_current_password" :value="__('Current Password')" />
        ...
        <div>
            <x-input-label class="text-xl" for="update_password_password" :value="__('New Password')" />
        ...
        <div>
            <x-input-label class="text-xl" for="update_password_password_confirmation" :value="__('Confirm Password')" />
